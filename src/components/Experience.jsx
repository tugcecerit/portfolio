    ...
    <div className="horizontal-container">
      <div className="horizontal-wrapper mb-10">
        <div className="horizontal-scroller">
          <div className="row">
            <div className="item relative p-5 border-2 border-white rounded-2xl box-border text-5xl flex flex-col justify-center items-center h-50 text-[#ffaa00] font-normal w-50 text-shadow-md filled max-sm:w-96">
              <h1 className='text-[#ffaa00]'>WHAT I HAVE DONE SO FAR</h1>
            </div>
            <div className="item relative p-5 border-2 border-white rounded-2xl box-border text-2xl flex flex-col justify-between items-start h-50 text-[#ffaa00] font-normal w-50 text-shadow-md big max-sm:w-96">
            ...
            <h3 className="text-[#ffaa00] text-lg sm:text-xl py-2 md:text-2xl lg:text-3xl xl:text-4xl font-semibold">Area Sales and CS Supervisor</h3>
              <h5 className="company text-md sm:text-lg md:text-2l lg:text-2xl xl:text-3xl font-medium">Mavi</h5>
            ...
            <div className="item relative p-5 border-2 border-white rounded-2xl box-border text-2xl flex flex-col justify-between items-start h-50 text-white font-normal w-50 text-shadow-md filled max-sm:w-96">
            <h3 className="text-[#ffaa00] text-lg sm:text-xl py-2 md:text-2xl lg:text-3xl xl:text-4xl font-semibold">Export Sales Representative</h3>
              <h5 className="company text-md sm:text-lg md:text-2l lg:text-2xl xl:text-3xl font-medium">Gulsan Holding</h5>
          ...
          <div className="row">
            ...
            <div className="item relative p-5 border-2 border-white rounded-2xl box-border text-2xl flex flex-col justify-between items-start h-50 text-white font-normal w-50 text-shadow-md filled max-sm:w-96">
              <h3 className="text-[#ffaa00] text-lg sm:text-xl py-2 md:text-2xl lg:text-3xl xl:text-4xl font-semibold">Software Engineering Fellow</h3>
              <h5 className="company text-md sm:text-lg md:text-2l lg:text-2xl xl:text-3xl font-medium">General Assembly</h5>
            ...
            <div className="item relative p-5 border-2 border-white rounded-2xl box-border text-2xl flex flex-col justify-between items-start h-50 text-white font-normal w-50 text-shadow-md filled max-sm:w-96">
              <h3 className="text-[#ffaa00] text-lg sm:text-xl py-2 md:text-2xl lg:text-3xl xl:text-4xl font-semibold">Export Sales and Marketing Specialist</h3>
              <h5 className="company text-md sm:text-lg md:text-2l lg:text-2xl xl:text-3xl font-medium">Sanko Holding</h5>
